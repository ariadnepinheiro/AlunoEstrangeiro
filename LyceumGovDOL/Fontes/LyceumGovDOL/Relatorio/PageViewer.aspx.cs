...
{
    public partial class _PageViewer : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (relatorio.ToLower() == "chdocenteonline" && !string.IsNullOrEmpty(Request.QueryString["matricula"]))
                    {
                        paramList.Add(new ReportParameter("matricula", HttpContext.Current.User.Identity.Name, true));
                    }
