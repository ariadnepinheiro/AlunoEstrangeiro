<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="403.aspx.cs" Inherits="Techne.Lyceum.Net.Manutencao._03"
...
<asp:Content ID="conErro" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <p>
        <img src="../images/img_interrog.png" width="128" height="128" align="left" /><strong
            style="text-decoration: underline;">Aconteceu o Seguinte Erro de Usabilidade:</strong></p>
    <p>
        A página não pode ser exibida porque o usuário não tem permissão de acesso, ou falta
        de conexão para continuar a navegabilidade.<br />
