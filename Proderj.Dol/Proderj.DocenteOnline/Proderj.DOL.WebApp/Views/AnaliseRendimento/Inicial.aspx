<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Proderj.DOL.WebApp.Models.AnaliseRendimentoViewModel>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" runat="server">
    <div  style="
        ...
        padding: 20px 0;
        border-radius: 15px;">
      <%--  <iframe id="frResultado" runat="server" width="80%" height="800px" frameborder="1" src="https://app.powerbi.com/view?r=eyJrIjoiZGI5MWZmYTAtYTg4Yy00NTM5LTg2ZjQtN2QwOWExODBmYWMxIiwidCI6IjBjMjgyOWM5LTQxZmEtNDg4NS1iMDU3LWEzMjdmYTVmMzdkNCJ9&pageName=ReportSectionb59d51d585a920a5d8eb"
