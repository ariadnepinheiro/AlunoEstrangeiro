...
{
    public class LY_PESSOA
    {
        public LY_PESSOA()
        {
            LY_DOCENTE = new HashSet<LY_DOCENTE>();
        }
        ...
        //public virtual double? QT_FILHOS { get; set; }
        ...
        //public virtual string MAE_FALECIDA { get; set; }
        //public virtual string PAI_FALECIDO { get; set; }
        ...
        public virtual string AREA_QUILOMBOS { get; set; }
        public virtual string TERRA_INDIGENA { get; set; }
        public virtual string AREA_ASSENTAMENTO { get; set; }

        public virtual ICollection<LY_DOCENTE> LY_DOCENTE { get; set; }

        public virtual LY_FL_PESSOA LY_FL_PESSOA { get; set; }
    }
}
