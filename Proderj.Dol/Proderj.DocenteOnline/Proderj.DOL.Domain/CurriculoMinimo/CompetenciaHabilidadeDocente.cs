...
namespace Proderj.DOL.Domain
{
    ...
    {
		public CompetenciaHabilidadeDocente()
		{
			CompetenciaHabilidadeItem = new CompetenciaHabilidadeItem();
        }
		...
		public virtual CompetenciaHabilidadeItem CompetenciaHabilidadeItem { get; set; }
    }
}
