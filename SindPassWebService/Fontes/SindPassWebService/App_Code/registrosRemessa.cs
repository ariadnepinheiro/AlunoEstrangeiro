...
public class registrosremessa : WebService
{
    ...
    public registroRemessaResponse registros_Remessa(string nomeArquivo)
    {
        ...
        var sql1 = "SELECT distinct nomeArquivo, quantidaderegistros FROM RIOCARD_REMESSA where nomearquivo = '" + nomeArquivo + "' AND nomearquivo like 'SNDSEE%'";
        ...
        var sql = "SELECT tipomovimentacao, matriculanova, nomealuno, alunodatanascimento, " +
                  ...
                  "codigocenso, qhiturno, qhiturma, alunofoto, gratuidade, modalTREM, modalONIBUS, modalMETRO, modalBARCAS from riocard_remessa where nomearquivo = '" + nomeArquivo + "' AND nomearquivo like 'SNDSEE%'";
