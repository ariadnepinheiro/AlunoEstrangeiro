...
public class arquivosRemessa : WebService
{
    ...
    public arquivosRemessaResponse arquivos_Remessa()
    {
        ...
        var sql = "SELECT arquivo, quantidaderegistros, data FROM RIOCARD_ARQUIVOREMESSA WHERE arquivo like 'SNDSEE%'";

        var sql1 = "SELECT count(*) as quantidadeArquivos FROM RIOCARD_ARQUIVOREMESSA WHERE arquivo like 'SNDSEE%'";
