...
namespace Techne.Lyceum.RN.Transporte
{
    public class TipoContratacao
    {
        public DataTable Lista()
        {
            ...
            try
            {
                contextQuery.Command = @" SELECT TIPOCONTRATACAOID,
                                           ...
                                           DATACADASTRO,
                                           DATAALTERACAO
                                    FROM   [Transporte].[TIPOCONTRATACAO] (NOLOCK) ";
        ...
        public ValidacaoDados Valida(Entidades.TipoContratacao tipoContratacao, bool cadastro)
        {
            ...
            else if (tipoContratacao.Descricao.Length > 500)
            {
        ...
        public void Insere(Entidades.TipoContratacao tipoContratacao)
        {
            ...
            try
            {
                contextQuery.Command = @" INSERT INTO Transporte.TIPOCONTRATACAO
                                                        (DESCRICAO, 
                                                         ATIVO, 
                                                         USUARIOID, 
                                                         DATACADASTRO, 
                ...
                contextQuery.Parameters.Add("@ATIVO", SqlDbType.Bit, tipoContratacao.Ativo);
        ...
        public void Atualiza(Entidades.TipoContratacao tipoContratacao)
        {
            ...
            try
            {
                contextQuery.Command = @" UPDATE Transporte.TIPOCONTRATACAO
        ...
        public ValidacaoDados ValidaRemocao(int tipoContratacaoId)
        {
            List<string> mensagens = new List<string>();
            DataContext contexto = null;
            RN.Transporte.RotaTrajeto rnRotaTrajeto = new RotaTrajeto();
            ValidacaoDados validacaoDados = new ValidacaoDados
            {
                Valido = false
            };
            ...
            if (mensagens.Count == 0)
            {
                try
                {
                    ...
                    if (rnRotaTrajeto.PossuiTipoContratacaoPor(contexto, tipoContratacaoId))
                    {
                        mensagens.Add("Registro não pode ser excluído, pois existem Rotas associadas a esse tipo de Calculo de Pagamento.");
                    }
                }
                catch
                {
        ...
        public void Remove(int tipoContratacaoId)
        {
            ...
            try
            {
                contextQuery.Command = @" DELETE Transporte.TIPOCONTRATACAO
                            WHERE  TIPOCONTRATACAOID = @TIPOCONTRATACAOID  ";
