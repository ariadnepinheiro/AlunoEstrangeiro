...
{
    [AtributoTabela("Matricula.CONTATOOPCAOINSCRICAOHIST", Nome = "Matricula.CONTATOOPCAOINSCRICAOHIST")]
    public class ContatoOpcaoInscricaoHist : IEntity
    {
        [AtributoCampo(Nome = "CONTATOOPCAOINSCRICAOHISTID")]
        public int ContatoOpcaoInscricaoHistId { get; set; }
