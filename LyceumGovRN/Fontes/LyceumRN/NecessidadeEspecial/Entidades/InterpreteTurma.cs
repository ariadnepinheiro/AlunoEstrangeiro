...
{
    [AtributoTabela("NecessidadeEspecial.InterpreteTurma", Nome = "NecessidadeEspecial.InterpreteTurma")]
    public class InterpreteTurma : IEntity
    {
        [AtributoCampo(Nome = "INTERPRETETURMAID")]
        public int InterpreteTurmaId { get; set; }
