...
namespace Techne.Lyceum.RN.Turmas
{
    public class PeriodoFrequenciaAluno
    {
        public DataTable Lista()
        {
            ...
            try
            {
                contextQuery.Command = @" SELECT PERIODOFREQUENCIAALUNOID, 
                           ...
                           DATACADASTRO, 
                           DATAALTERACAO 
                    FROM   [TURMA].PERIODOFREQUENCIAALUNO (NOLOCK)  ";
        ...
        public Entidades.PeriodoFrequenciaAluno ObtemPor(int ano, int mes)
        {
            ...
            Entidades.PeriodoFrequenciaAluno periodo = new Techne.Lyceum.RN.Turmas.Entidades.PeriodoFrequenciaAluno();
            ContextQuery contextQuery = new ContextQuery();

            try
            {
                contextQuery.Command = @" SELECT *
                                        FROM TURMA.PERIODOFREQUENCIAALUNO
                                        WHERE ANO = @ANO
	                                        AND MES = @MES ";
        ...
        public void Insere(Entidades.PeriodoFrequenciaAluno periodoLancamento)
        {
            ...
            try
            {
                contextQuery.Command = @"  INSERT INTO TURMA.PERIODOFREQUENCIAALUNO
                                                (ANO,
                                                 MES,
                                                 DATAINICIO,
                                                 DATAFIM,
        ...
        public void Atualiza(Entidades.PeriodoFrequenciaAluno periodoLancamento)
        {
            ...
            try
            {
                contextQuery.Command = @" UPDATE TURMA.PERIODOFREQUENCIAALUNO
        ...
        public void Remove(int periodoFrequenciaAlunoId)
        {
            ...
            try
            {
                contextQuery.Command = @" DELETE TURMA.PERIODOFREQUENCIAALUNO
                            WHERE  PERIODOFREQUENCIAALUNOID = @PERIODOFREQUENCIAALUNOID  ";
