...
{
    [AtributoTabela("PrestacaoContas.OPERACAOEXIGENCIAARQUIVO", Nome = "PrestacaoContas.OPERACAOEXIGENCIAARQUIVO")]
    public class OperacaoExigenciaArquivo : IEntity
    {
        [AtributoCampo(Nome = "OPERACAOEXIGENCIAARQUIVOID")]
        public int OperacaoExigenciaArquivoId { get; set; }
