...
{
    [AtributoTabela("PrestacaoContas.EXTRATOBANCARIOARQUIVO", Nome = "PrestacaoContas.EXTRATOBANCARIOARQUIVO")]
    public class ExtratoBancarioArquivo : IEntity
    {
        [AtributoCampo(Nome = "EXTRATOBANCARIOARQUIVOID")]
