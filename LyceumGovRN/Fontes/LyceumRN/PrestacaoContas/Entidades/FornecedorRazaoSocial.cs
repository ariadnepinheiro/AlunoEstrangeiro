...
{
    [AtributoTabela("PrestacaoContas.FORNECEDORRAZAOSOCIAL", Nome = "PrestacaoContas.FORNECEDORRAZAOSOCIAL")]
    public class FornecedorRazaoSocial : IEntity
    {
        [AtributoCampo(Nome = "FORNECEDORRAZAOSOCIALID")]
