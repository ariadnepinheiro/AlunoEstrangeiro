...
{
    [AtributoTabela("PrestacaoContas.EXIGENCIAEVENTOARQUIVO", Nome = "PrestacaoContas.EXIGENCIAEVENTOARQUIVO")]
    public class ExigenciaEventoArquivo : IEntity
    {
        [AtributoCampo(Nome = "EXIGENCIAEVENTOARQUIVOID")]
        public int ExigenciaEventoArquivoId { get; set; }
