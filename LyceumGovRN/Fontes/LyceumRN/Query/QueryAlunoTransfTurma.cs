...
namespace Techne.Lyceum.RN.Query
{
    ...
    public class QueryAlunoTransfTurma : LyceumQuery
    {
        public QueryAlunoTransfTurma()
        {
            ...
            this.GridColumns.Add(new TSearchColumn { FieldName = "curriculo", Caption = "curriculo", Width = Unit.Percentage(0), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "serie", Caption = "serie", Width = Unit.Percentage(0), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "unidade_ensino", Caption = "unidade_ensino", Width = Unit.Percentage(0), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "sit_aluno", Caption = "sit_aluno", Width = Unit.Percentage(0), Visible = false });
