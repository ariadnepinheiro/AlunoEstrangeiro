...
{
    public class QueryServidor : LyceumQuery
    {
        public QueryServidor()
        {
            ...
            this.GridColumns.Add(new TSearchColumn() { FieldName = "mae", Caption = "Nome da Mãe", Width = Unit.Percentage(10) });
            this.GridColumns.Add(new TSearchColumn() { FieldName = "pai", Caption = "Nome do Pai", Width = Unit.Percentage(10) });
            ...
            this.GridFilterParameters.Add("unidade_ens", "Unidade de Ensino", TSearchDataType.String, 300);
        ...
        public override DataView GetData(IDictionary<string, object> pars, object key, int maxRows)
        {
            ...
            else
            {
                ...
                {
                    sql.Append(" and ue.nome_comp like ? ");
                    string unidade_ens = LikeExpression(pars["unidade_ens"].ToString());
                    parValues.Add(unidade_ens);
                }                
            }
