...
{
    public class QueryAlunoAssociacaoTransporte : LyceumQuery
    {

        public QueryAlunoAssociacaoTransporte()
        {
        ...
        public override DataView GetData(IDictionary<string, object> pars, object key, int maxRows)
        {
            ...
            try
            {
                ...
                {
                    mensagens.Add("O campo Escola é de preenchimento obrigatório.");
               ...
               // mensagens = validaFiltroAnalise(pars);
                ...
                if (this.HasValue(pars, "unidade_ens"))
                {
                    contextQueryPar.Command += " AND a.UNIDADE_ENSINO  = @UNIDADE_ENS ";
                    contextQuery.Parameters.Add("@UNIDADE_ENS", pars["unidade_ens"].ToString());
                }
        ...
        private List<string> validaFiltroAnalise(IDictionary<string, object> pars)
        {
            ...
            if (!this.HasValue(pars, "Turno"))
            {
                erros.Add("O campo Turnos é de preenchimento obrigatório.");
            }            
