namespace Techne.Lyceum.RN.Query
{
    ...
    public class QueryAlunoNotificacao : LyceumQuery
    {
        public QueryAlunoNotificacao()
        {
            ...
            this.GridColumns.Add(new TSearchColumn { FieldName = "idade", Caption = "Idade", Width = Unit.Percentage(10) });
            this.GridColumns.Add(new TSearchColumn { FieldName = "pessoa", Caption = "pessoa", Width = Unit.Percentage(0), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "sit_aluno", Caption = "Situação", Width = Unit.Percentage(20) });
