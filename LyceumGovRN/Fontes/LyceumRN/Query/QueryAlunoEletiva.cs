namespace Techne.Lyceum.RN.Query
{
    ...
    public class QueryAlunoEletiva : LyceumQuery
    {
        public QueryAlunoEletiva()
        {
            this.GridColumns.Add(new TSearchColumn { FieldName = "aluno", Caption = "Matrícula", Width = Unit.Percentage(15) });
            ...
            this.GridColumns.Add(new TSearchColumn { FieldName = "mae", Caption = "Nome da Mãe", Width = Unit.Percentage(35) });
            this.GridColumns.Add(new TSearchColumn { FieldName = "pessoa", Caption = "pessoa", Width = Unit.Percentage(0), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "unidade_ensino", Caption = "unidade_ensino", Width = Unit.Percentage(20), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "curso", Caption = "curso", Width = Unit.Percentage(20), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "serie", Caption = "serie", Width = Unit.Percentage(20), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "turno", Caption = "turno", Width = Unit.Percentage(20), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "itinerarioformativo", Caption = "itinerario", Width = Unit.Percentage(20), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "tipo", Caption = "tipo", Width = Unit.Percentage(20), Visible = false });
            this.GridColumns.Add(new TSearchColumn { FieldName = "modalidade", Caption = "modalidade", Width = Unit.Percentage(20), Visible = false });
            ...
            contextQuery.Command +=
                ...
                contextQuery.Command += @"               
                                ...
                                FROM    #MATRICULAS_ESPECIAIS ME
                                        ...
                                        INNER JOIN LY_CURSO C ON C.CURSO = ME.CURSO
                                        LEFT JOIN HADES.dbo.NECESSIDADEESPECIAL NEC ON NEC.NECESSIDADEESPECIALID=P.NECESSIDADEESPECIALID
                ...
                else if ((this.HasValue(pars, "fonetizar") && pars["fonetizar"].ToString() == "false") && contextQueryParPessoa.Command != null)
                {
                    contextQuery.Command += @" 
                                                    DROP TABLE #PESSOA  ";
                }
