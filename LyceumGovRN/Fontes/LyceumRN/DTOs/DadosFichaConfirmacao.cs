...
{
    public class DadosFichaConfirmacao
    {
        ...
        #region RG Detran
        public string NumeroRGDetran { get; set; }

        public DateTime? DataExpedicaoRGDetran { get; set; }
        #endregion
        ...
        #region Transporte
        public string UtilizaTransporte { get; set; }

        public string PoderResponsavel { get; set; }

        public string Modais { get; set; }        
        #endregion

        #region Confirmacao Matricula
        ...
        public string LinguaEstrangueira { get; set; }
