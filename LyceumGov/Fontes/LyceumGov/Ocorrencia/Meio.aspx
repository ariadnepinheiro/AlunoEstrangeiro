<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="Meio.aspx.cs" Inherits="Techne.Lyceum.Net.Ocorrencia.Meio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    <asp:ObjectDataSource ID="odsMeio" runat="server" TypeName="Techne.Lyceum.Net.Ocorrencia.Meio"
        SelectMethod="Lista" InsertMethod="Insert" UpdateMethod="Update" DeleteMethod="Delete">
    </asp:ObjectDataSource>
    <dxwgv:ASPxGridView ID="grdMeio" runat="server" DataSourceID="odsMeio"
        KeyFieldName="MEIOID" AutoGenerateColumns="false"
        ClientInstanceName="grdMeio" OnInitNewRow="grdMeio_InitNewRow"
        OnStartRowEditing="grdMeio_StartRowEditing" OnRowInserting="grdMeio_RowInserting"
        OnRowUpdating="grdMeio_RowUpdating" OnRowDeleting="grdMeio_RowDeleting"
        OnAfterPerformCallback="grdMeio_AfterPerformCallback"
        Width="50%">
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="MEIOID"
