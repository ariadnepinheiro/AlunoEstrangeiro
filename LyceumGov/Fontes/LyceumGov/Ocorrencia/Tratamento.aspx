<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="Tratamento.aspx.cs" Inherits="Techne.Lyceum.Net.Ocorrencia.Tratamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    <asp:ObjectDataSource ID="odsTratamento" runat="server" TypeName="Techne.Lyceum.Net.Ocorrencia.Tratamento"
        SelectMethod="Lista" InsertMethod="Insert" UpdateMethod="Update" DeleteMethod="Delete">
    </asp:ObjectDataSource>
    <dxwgv:ASPxGridView ID="grdTratamento" runat="server" DataSourceID="odsTratamento"
        KeyFieldName="TRATAMENTOID" AutoGenerateColumns="false" ClientInstanceName="grdTratamento"
        OnInitNewRow="grdTratamento_InitNewRow" OnStartRowEditing="grdTratamento_StartRowEditing"
        OnRowInserting="grdTratamento_RowInserting" OnRowUpdating="grdTratamento_RowUpdating"
        OnRowDeleting="grdTratamento_RowDeleting" OnAfterPerformCallback="grdTratamento_AfterPerformCallback"
        Width="50%">
        ...
        <Columns>
                ...
                <HeaderCaptionTemplate>
                    <div style="text-align: center">
                        <img id="btnNovoGrid" runat="server" alt="Novo" style="cursor: pointer" src="../img/bt_novo.png"
                            onclick="grdTratamento.AddNewRow();" />
                    </div>
                </HeaderCaptionTemplate>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="TRATAMENTOID"
