...
namespace Techne.Lyceum.Net.Reposicao
{
    ...
    NavUrl("~/Patrimonio/PeriodoLancamento.aspx"),
     ...
     Title("Período Lançamento - Greve"),
   ]
    ...
    public partial class PeriodoLancamento : TPage
    {
        ...
        {
            TituloGrid(grdPeriodoLancamento, "Períodos Lançamento - Greve");
        }
        ...
        public void Insert(object ANO, object DATAINICIO, object DATAFIM, object DATAINICIOGREVE, object DATAFIMGREVE) { }
        public void Update(object ANO, object DATAINICIO, object DATAFIM, object DATAINICIOGREVE, object DATAFIMGREVE, object PERIODOLANCAMENTOID) { }
        ...
        protected void grdPeriodoLancamento_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            periodoLancamento.DataInicioGreve = e.NewValues["DATAINICIOGREVE"] != null ? Convert.ToDateTime(e.NewValues["DATAINICIOGREVE"]) : DateTime.MinValue;
            periodoLancamento.DataFimGreve = e.NewValues["DATAFIMGREVE"] != null ? Convert.ToDateTime(e.NewValues["DATAFIMGREVE"]) : DateTime.MinValue;
        ...
        protected void grdPeriodoLancamento_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            validacao = rnPeriodoLancamento.Valida(periodoLancamento, false);
        ...
        protected void grdPeriodoLancamento_CellEditorInitialize(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewEditorEventArgs e)
        {
            ...
            else if (grdPeriodoLancamento.IsEditing)
            {
                ...
                if ((e.Column.FieldName == "DATAINICIOGREVE"))
                {
                    e.Editor.ReadOnly = true;
                }
                if ((e.Column.FieldName == "DATAFIMGREVE"))
                {
                    e.Editor.ReadOnly = true;
                }
            }
