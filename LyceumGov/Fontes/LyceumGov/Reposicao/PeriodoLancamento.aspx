<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="PeriodoLancamento.aspx.cs" Inherits="Techne.Lyceum.Net.Reposicao.PeriodoLancamento" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    <asp:ObjectDataSource ID="odsPeriodoLancamento" runat="server" TypeName="Techne.Lyceum.Net.Reposicao.PeriodoLancamento"
    ...
    <dxwgv:ASPxGridView ID="grdPeriodoLancamento" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataComboBoxColumn Caption="Ano*" FieldName="ANO" VisibleIndex="3"
                ...
                <PropertiesComboBox ValueType="System.String" DataSourceID="odsAno" TextField="ANO"
                    ...
                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                        <RequiredField ErrorText="Favor selecionar um ano." IsRequired="True" />
                    </ValidationSettings>
                </PropertiesComboBox>
            ...
            <dxwgv:GridViewDataDateColumn Caption="Início Período Greve*" HeaderStyle-Font-Bold="true"
                FieldName="DATAINICIOGREVE" VisibleIndex="7" Width="200px">
                <PropertiesDateEdit Width="200px">
                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                        <RequiredField ErrorText="Favor informar o início do período de greve." IsRequired="True" />
                    </ValidationSettings>
                </PropertiesDateEdit>
                <HeaderStyle Font-Bold="True"></HeaderStyle>
            </dxwgv:GridViewDataDateColumn>
            <dxwgv:GridViewDataDateColumn Caption="Término Período Greve*" HeaderStyle-Font-Bold="true"
                FieldName="DATAFIMGREVE" VisibleIndex="8" Width="200px">
                <PropertiesDateEdit Width="200px">
                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                        <RequiredField ErrorText="Favor informar o término do período de greve." IsRequired="True" />
                    </ValidationSettings>
                </PropertiesDateEdit>
                <HeaderStyle Font-Bold="True"></HeaderStyle>
            </dxwgv:GridViewDataDateColumn>
