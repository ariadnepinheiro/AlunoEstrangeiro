<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="PeriodoFrequenciaAlunoCorrecao.aspx.cs" Inherits="Techne.Lyceum.Net.Basico.PeriodoFrequenciaAlunoCorrecao" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    <asp:ObjectDataSource ID="odsPeriodoLancamento" runat="server" TypeName="Techne.Lyceum.Net.Basico.PeriodoFrequenciaAlunoCorrecao"
    ...
    <dxwgv:ASPxGridView ID="grdPeriodo" runat="server" AutoGenerateColumns="False"
        ClientInstanceName="grdPeriodo" DataSourceID="odsPeriodoLancamento"
        KeyFieldName="PERIODOFREQUENCIAALUNOID" OnRowDeleting="grdPeriodo_RowDeleting"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="PERIODOFREQUENCIAALUNOID"
