<%@ Page Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="ManutencaoMatriculaDocente.aspx.cs" Inherits="Techne.Lyceum.Net.Basico.ManutencaoMatriculaDocente"
    Title="Manutenção de Matrícula de Docente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
            ...
            <tr>
                ...
                <td>
                    <tweb:TSearch ID="tseDocente" runat="server" SettingsTypeName="Techne.Lyceum.RN.Query.QueryDocente"
                        AutoPostBack="true" OnTextChanged="tseDocente_Changed">
                    </tweb:TSearch>
                </td>
            </tr>
        </table>
    ...
    <div class="divEditBlock" style="width: 968px;">
        ...
        <asp:Label runat="server" ID="Label1" Text="Docentes" SkinID="BcTitulo" />
    ...
    <asp:Panel ID="pnAbas" runat="server" Width="1000px" Visible="false">
        <dxtc:ASPxPageControl ID="pcManutencaoDocentes" runat="server" ActiveTabIndex="0"
            Width="800px">
            <TabPages>
                <dxtc:TabPage Text="Situação Atual">
                    <ContentCollection>
                        <dxw:ContentControl ID="ContentControl1" runat="server">
                            ...
                            <br />
                            <br />
                            <dxwgv:ASPxGridView ID="grdSituacao" runat="server" OnAfterPerformCallback="grdSituacao_AfterPerformCallback"
                                AutoGenerateColumns="False" ClientInstanceName="grdSituacao">
                                <SettingsPager PageSize="10" />
                                <Columns>
                                    <dxwgv:GridViewDataTextColumn Caption="Id/Vínculo" FieldName="IDVINCULO" VisibleIndex="1">
                                    </dxwgv:GridViewDataTextColumn>
                                    ...
                                    <dxwgv:GridViewDataTextColumn Caption="Situação" FieldName="DESCRICAO" VisibleIndex="3"
                                        Width="100px">
                                    </dxwgv:GridViewDataTextColumn>
