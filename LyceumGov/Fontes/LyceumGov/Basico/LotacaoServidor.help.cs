...
{
	public partial class LotacaoServidor
	{
		public override void HelpInit(HelpData help)
		{
			help.ShowDefaultHelp = false;
			help.Summary.Add("Consultar, cadastrar, alterar e remover lotações e situações de servidores.");
			help.Oper.Add("Para consultar, cadastrar, alterar ou remover uma lotação/situação é necessário fazer uma pesquisa pelo servidor/funcionário de interesse.");
			help.Oper.Add("A pesquisa pode ser feita pela nome, matrícula, documento e/ou CPF do servidor/funcionário. Após definidas estas informações, deve-se clicar em 'Buscar'. O resultado da pesquisa aparecerá em uma lista suspensa.");
			help.Oper.Add("Deve-se selecionar o servidor/funcionário de interesse clicando na linha em que o servidor/funcionário aparece na lista suspensa.");

			help.Oper.TitleAdd("Consultando lotações/situações de um servidor");
			help.Oper.Add("A consulta é realizada automaticamente quando o servidor de interesse for selecionado");
			help.Oper.Add("Os dados das lotações/situações associadas ao servidor selecionado serão exibidos na grade de lotações e na grade de situações.");
			...
			help.Oper.TitleAdd("Cadastrando nova lotação/situação para um servidor");
			help.Oper.Add("Para cadastrar uma nova lotação/situação é necessário fazer a consulta do servidor desejado. Ver 'Consultando lotações de um servidor'.");
			help.Oper.Add("Para cadastrar uma nova lotação/situação associada ao servidor selecionado deve-se clicar no botão ?I da respectiva grade.", "~/img/bt_novo.png");
			...
			help.Oper.TitleAdd("Alterando lotação/situação de um servidor");
			help.Oper.Add("Para alterar uma lotação/situação é necessário fazer a consulta do servidor desejado. Ver 'Consultando lotações de um servidor'.");
			help.Oper.Add("Para alterar os dados de uma lotação/situação associada ao servidor selecionado deve-se clicar no botão ?I.", "~/img/bt_editar.png");
			...
			help.Oper.TitleAdd("Removendo lotação/situação de um servidor");
            help.Oper.Add("Para remover uma lotação/situação é necessário fazer a consulta do servidor desejado. Ver 'Consultando lotações de um servidor'.");
            help.Oper.Add("Para remover uma lotação/situação associada ao servidor selecionado deve-se clicar no botão ?I e confirmar a remoção do registro.", "~/img/bt_exclui2.png");
            ...
            help.Oper.Add("• Matrícula: Matrícula do servidor. (Tabela: Servidores/Funcionários)");
			...
			help.Oper.Add("• Data da Nomeação: Data da nomeação do servidor.");
			help.Oper.Add("• Data da Publicação da Nomeação: Data da publicação da nomeação do servidor.");
			help.Oper.Add("• Data da Dispensa: Data da dispensa do servidor.");
			help.Oper.Add("• Documentação: Indica se o servidor é responsável por documentação.");
			help.Oper.Add("• Data da Publicação da Dispensa: Data da publicação da dispensa do servidor.");
			help.Oper.Add("• Ato oficial: Ato oficial da nomeação do servidor.");
            help.Oper.Add("• Situação: Motivo da licença. (Tabela: Ly_licenca_pessoa)");
