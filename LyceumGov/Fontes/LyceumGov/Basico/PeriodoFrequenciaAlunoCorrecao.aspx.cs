...
{
    [
    NavUrl("~/Basico/PeriodoFrequenciaAlunoCorrecao.aspx"),
     ControlText("PeriodoFrequenciaAlunoCorrecao"),
     Title("Período Correção – Frequência Aluno"),
   ]

    public partial class PeriodoFrequenciaAlunoCorrecao : TPage
    {
        public object Lista()
        {
            RN.PeDeMeiaCorrecao.PeriodoFrequenciaAluno rnPeriodoLancamento = new Techne.Lyceum.RN.PeDeMeiaCorrecao.PeriodoFrequenciaAluno();
        ...
        {
            TituloGrid(grdPeriodo, "Períodos Lançamento Frequência Aluno - Correção");
        }
        ...
        protected void grdPeriodo_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            RN.PeDeMeiaCorrecao.Entidades.PeriodoFrequenciaAluno periodoLancamento = new Techne.Lyceum.RN.PeDeMeiaCorrecao.Entidades.PeriodoFrequenciaAluno();
            RN.PeDeMeiaCorrecao.PeriodoFrequenciaAluno rnPeriodoLancamento = new Techne.Lyceum.RN.PeDeMeiaCorrecao.PeriodoFrequenciaAluno();
