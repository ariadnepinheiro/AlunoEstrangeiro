...
<asp:Content ID="conFuncaoGLP" ContentPlaceHolderID="cphFormulario" runat="server">
        ...
        <!-- O que será exibido enquanto o carregamento acontece -->
        <asp:UpdateProgress ID="updProgress" runat="server" AssociatedUpdatePanelID="UP_AnaliseGLP">
            <ProgressTemplate>
                <div class="loading-overlay">
                    <img src="../Images/ajax-loader.gif" alt="Carregando..." style="width: 50px;" />
                    <span>Processando, aguarde...</span>
                </div>
            </ProgressTemplate>
        </asp:UpdateProgress>
        <asp:UpdatePanel ID="UP_AnaliseGLP" runat="server" UpdateMode="Conditional">
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="tseRegional" />
                <asp:AsyncPostBackTrigger ControlID="tseMunicipio" />
                <asp:AsyncPostBackTrigger ControlID="tseUnidade_Ensino" />
            ...
            <ContentTemplate>
                <asp:Panel ID="pnBusca" runat="server" GroupingText="Faça uma busca por unidade administrativa"
                    Width="700px" Style="padding: 0; margin: 0;">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            inner join LY_DOCENTE_FUNCAO_GLP df on df.UNIDADE_ENS = ue.UNIDADE_ENS inner join municipio m on ue.municipio = m.CODIGO INNER JOIN TCE_REGIONAL R ON ue.ID_REGIONAL=R.ID_REGIONAL"
                                    OnChanged="tseUnidade_Ensino_Changed" GridWidth="750px" SqlOrder="r.REGIONAL, m.NOME,nome_comp"
                                    SqlWhere="ue.id_regional = #tseRegional# and ue.municipio = #tseMunicipio#  and df.STATUS = 'Aguardando' and df.ano = DATEPART(YEAR ,GETDATE()) and df.mes = DATEPART(MONTH ,GETDATE()) ">
                                    <GridColumns>
                ...
                <div>
                    <div id="divBotoes" class="div-botoes" runat="server" visible="false">
                        <asp:Button ID="btnAceitarTodos" OnCommand="btnAcaoTodos_Command" CommandArgument="A"
                            runat="server" Text="Aceitar Selecionados" CssClass="btn-estilizado"/>
                        <asp:Button ID="btnReprovarTodos" OnCommand="btnAcaoTodos_Command" CommandArgument="R"
                            runat="server" Text="Reprovar Selecionados" CssClass="btn-estilizado" />
                    </div>
                    <asp:Panel ID="pnlAnaliseGLP" runat="server" Visible="false">
                        <dxwgv:ASPxGridView ID="grdDocenteFuncaoGLP" runat="server" AutoGenerateColumns="False"
                            Width="100%" Visible="false" ClientInstanceName="grdDocenteFuncaoGLP" DataSourceID="odsDocenteFuncaoGLP"
                            KeyFieldName="ID_DOCENTE_FUNCAO_GLP" OnAfterPerformCallback="grdDocenteFuncaoGLP_AfterPerformCallback"
                            OnCustomJSProperties="grdDocenteFuncaoGLP_CustomJSProperties" EnableCallBacks="false"
                            OnCustomColumnDisplayText="grdDocenteFuncaoGLP_CustomColumnDisplayText">
                            <SettingsBehavior ConfirmDelete="True" />
                            <SettingsEditing Mode="Inline" />
                            <SettingsText EmptyDataRow="Não existem dados." />
                            <Columns>
                                <dxwgv:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="15" Width="50px"
                                    Caption="Sel.">
                                    <HeaderTemplate>
                                        <dxe:ASPxCheckBox ID="chkSelectAll" runat="server" ClientSideEvents-CheckedChanged="function(s, e) { 
                                        grdDocenteFuncaoGLP.SelectAllRowsOnPage(s.GetChecked()); 
                                    }" />
                                    </HeaderTemplate>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="CH Livre no Município" FieldName="CH_LIVRE_MUNICIPIO"
                                    VisibleIndex="14">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
