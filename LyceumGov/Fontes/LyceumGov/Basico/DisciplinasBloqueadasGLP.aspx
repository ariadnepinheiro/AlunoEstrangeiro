<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="DisciplinasBloqueadasGLP.aspx.cs" Inherits="Techne.Lyceum.Net.Basico.DisciplinasBloqueadasGLP" %>

<asp:Content ID="conDisciplinasBloqueadas" ContentPlaceHolderID="cphFormulario" runat="server">
    <dxwgv:ASPxGridView ID="grdDisciplinas" runat="server" DataSourceID="tdsDisciplinasBloqueadas"
        ...
        OnRowValidating="grdDisciplinas_RowValidating" OnCellEditorInitialize="grdDisciplinas_CellEditorInitialize">
    ...
    <techne:TTableDataSource ID="tdsDisciplinas" runat="server" DataTableClassName="Techne.Lyceum.CR.Ly_grupo_habilitacao"
        SqlOrder="descricao" SqlWhere=" ATIVO='S'">
    </techne:TTableDataSource>
    <techne:TTableDataSource ID="tdsDisciplinasBloqueadas" runat="server" DataTableClassName="Techne.Lyceum.CR.Ly_evento_geral"
        SqlWhere="tipo_filtro = 'DisciplinasBloqueadas' and (dt_fim >= convert(date,Getdate()) or dt_fim is null)"
