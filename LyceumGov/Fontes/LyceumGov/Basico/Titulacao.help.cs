...
namespace Techne.Lyceum.Net.Basico
{
	public partial class Titulacao
	{
		public override void HelpInit(HelpData help)
		{
			...
			help.Summary.Add("Consultar, cadastrar, alterar e remover titulações.");

			help.Oper.TitleAdd("Consultando titulações");
			help.Oper.Add("Ao acessar a página de titulações, todas as titulações cadastradas serão exibidas.");
			...
			help.Oper.TitleAdd("Cadastrando nova titulação");
			help.Oper.Add("Para cadastrar uma nova titulação deve-se clicar no botão ?I.", "~/img/bt_novo.png");
			help.Oper.Add("Deve-se preencher os campos com os dados da nova titulação.");
			help.Oper.Add("Para salvar os dados da nova titulação deve-se clicar no botão ?I. Se algum campo obrigatório não estiver preenchido será exibido um alerta.", "~/img/bt_salvar.png");
			help.Oper.Add("Para cancelar a inclusão dos dados da titulação deve-se clicar no botão ?I.", "~/img/bt_cancelar.png");
			...
			help.Oper.TitleAdd("Alterando titulação");
			help.Oper.Add("Para alterar os dados de uma titulação deve-se clicar no botão ?I.", "~/img/bt_editar.png");
			...
			help.Oper.TitleAdd("Removendo titulação");
			help.Oper.Add("Para remover uma titulação deve-se clicar no botão ?I e confirmar a remoção do registro.", "~/img/bt_exclui2.png");
			...
			help.Oper.Add("• Titulação: Titulação conferida pela formação.");
			help.Oper.Add("• Descrição: Descrição detalhada da titulação.");
			help.Oper.Add("• Grau: Grau da titulação.");
