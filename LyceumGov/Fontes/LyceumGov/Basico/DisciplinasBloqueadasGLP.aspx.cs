...
{
    [NavUrl("~/Basico/DisciplinasBloqueadasGLP.aspx"),
      ControlText("DisciplinasBloqueadasGLP"),
      Title("Disciplinas Bloqueadas de GLP"),]

    public partial class DisciplinasBloqueadasGLP : TPage
    {
		protected void Page_Init(object sender, EventArgs e)
		{
            TituloGrid(grdDisciplinas, "Disciplinas Bloqueadas de GLP");
		}
        ...
        {
            e.NewValues["tipo_filtro"] = "DisciplinasBloqueadas";
        }
        ...
        protected void grdDisciplinas_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
			...
			{
				if (RN.Disciplina.ExisteDisciplinaBloqueadaGLP(e.NewValues["valor_filtro"].ToString(), dataini, datafim))
				{
