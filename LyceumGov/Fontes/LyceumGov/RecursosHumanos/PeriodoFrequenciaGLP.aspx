<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="PeriodoFrequenciaGLP.aspx.cs" Inherits="Techne.Lyceum.Net.RecursosHumanos.PeriodoFrequenciaGLP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    <asp:ObjectDataSource ID="odsPeriodoLancamento" runat="server" TypeName="Techne.Lyceum.Net.RecursosHumanos.PeriodoFrequenciaGLP"
    ...
    <dxwgv:ASPxGridView ID="grdPeriodo" runat="server" AutoGenerateColumns="False"
        ...
        KeyFieldName="PERIODOFREQUENCIAGLPID" OnRowDeleting="grdPeriodo_RowDeleting"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="PERIODOFREQUENCIAGLPID"
