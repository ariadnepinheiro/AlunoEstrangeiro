<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true" CodeBehind="TipoVeiculo.aspx.cs" Inherits="Techne.Lyceum.Net.Transporte.TipoVeiculo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
<asp:ObjectDataSource ID="odsTipoVeiculo" runat="server" TypeName="Techne.Lyceum.Net.Transporte.TipoVeiculo"
    ...
    <dxwgv:ASPxGridView ID="grdTipoVeiculo" runat="server" DataSourceID="odsTipoVeiculo"
        KeyFieldName="TIPOVEICULOID" AutoGenerateColumns="false" ClientInstanceName="grdTipoVeiculo"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="TIPOVEICULOID"
