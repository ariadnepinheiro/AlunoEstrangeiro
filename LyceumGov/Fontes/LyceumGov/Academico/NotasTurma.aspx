...
<asp:Content ID="cNotasTurma" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <script type="text/javascript">
        ...
        function TrataJustificativa() {
            ...
            var msgDependencia = "Declaro que solicitei à equipe pedagógica da unidade o contato com o aluno para que entregue o trabalho até o próximo trimestre";
                        ...
                        <fieldset style="height: 60px;">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%--<asp:Label ID="lblQuartoBimestre" runat="server" SkinID="lblObrigatorio" Text="4º Trimestre:"></asp:Label>--%>
                                    </td>
                                    <td>
    ...
    <br />
    <asp:CheckBox runat="server" ID="ckOpcao0" Text="Declaro que solicitei à equipe pedagógica da unidade que entre em contato com o aluno para fazer a entrega do trabalho até o próximo período." /><br />
    <asp:CheckBox runat="server" ID="ckOpcao1" Text="Declaro ter conhecimento do instrumento que formaliza o afastamento e solicitei à equipe pedagógica a aplicação residencial dos instrumentos de avaliação." /><br />
    <asp:CheckBox runat="server" ID="ckOpcao2" Text="Declaro que tomei as medidas cabíveis a respeito das faltas do aluno infrequente." /><br />
    <br />
