<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="FichaRenovacao.aspx.cs"
    EnableTheming="false" Inherits="Techne.Lyceum.Net.Academico.FichaRenovacao" %>
...
<body style="font-family: Arial; font-size: 11px">
    ...
    <div>
        ...
        <div>
            <strong>RENOVAÇÃO DE MATRICULA - VIA DO ALUNO</strong></div>
        ...
        <table style="width: 100%; border-spacing: 0;" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td colspan="2" align="justify" style="width: 200px">
                    <i>&#8220;Este documento não é válido como declaração de matrícula, tampouco aprovação
                        do aluno na série confirmada. Somente após o encerramento do ano letivo é que o
                        aluno estará aprovado ou reprovado. Caso tenha sido reprovado, deverá ser confirmada
                        sua matrícula na série em que foi reprovado.&#8221;</i>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <br />
        <div>
            <strong>RENOVAÇÃO DE MATRICULA - VIA UNIDADE DE ENSINO</strong></div>
