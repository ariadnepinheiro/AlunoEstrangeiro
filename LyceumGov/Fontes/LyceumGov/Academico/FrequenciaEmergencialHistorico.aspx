<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="FrequenciaEmergencialHistorico.aspx.cs" Inherits="Techne.Lyceum.Net.Academico.FrequenciaEmergencialHistorico" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel ID="pnlGridMatriculas" runat="server">
        <asp:ObjectDataSource ID="odsMatriculas" runat="server" TypeName="Techne.Lyceum.Net.Academico.FrequenciaEmergencialHistorico"
            SelectMethod="Lista">
            <SelectParameters>
