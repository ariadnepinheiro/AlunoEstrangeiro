...
{
    [
    NavUrl("~/Academico/FrequenciaEmergencial.aspx"),
    ControlText("FrequenciaEmergencial"),
    Title("Controle Frequência - Emergencial"),
]
    public partial class FrequenciaEmergencial : TPage
    {
        public object Lista(object turma, object ano, object periodo, object mes)
        {
            ...
            {
                return rnMatricula.ListaMatriculasElegiveisPor(turmafiltro, Convert.ToInt32(anofiltro), Convert.ToInt32(periodofiltro), Convert.ToInt32(mesfiltro));
            }
        ...
        private void CarregaTurma()
        {
            ...
            {
                ddlTurma.DataSource = rnTurma.ListaTurmaAbertaEnsinoMedioPor(Convert.ToInt32(ddlAno.SelectedValue), Convert.ToInt32(ddlPeriodo.SelectedValue), tseUnidadeResponsavel.DBValue.ToString());
