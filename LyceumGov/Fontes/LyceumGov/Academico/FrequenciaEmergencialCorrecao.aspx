<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="FrequenciaEmergencialCorrecao.aspx.cs" Inherits="Techne.Lyceum.Net.Academico.FrequenciaEmergencialCorrecao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel ID="pnlGridMatriculas" runat="server">
        <asp:ObjectDataSource ID="odsMatriculas" runat="server" TypeName="Techne.Lyceum.Net.Academico.FrequenciaEmergencialCorrecao"
            SelectMethod="Lista">
            <SelectParameters>
