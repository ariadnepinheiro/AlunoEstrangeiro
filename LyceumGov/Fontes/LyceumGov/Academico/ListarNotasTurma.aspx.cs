...
{
    [
        NavUrl("~/Academico/ListarNotasTurma.aspx"),
        ControlText("ListarNotasTurma"),
        Title("Notas por Turma"),
    ]

    public partial class ListarNotasTurma : TPage
    {
        #region Propriedades
        ...
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString.Keys.Count > 0 && !tseUnidadeResponsavel.IsValidDBValue)
        ...
        protected void grdGradeSerie_SelectionChanged(object sender, EventArgs e)
        {
            ...
            turma.Regional = ObjetoTurmaPesquisa.Regional;
            ...
            ASPxWebControl.RedirectOnCallback("NotasTurma.aspx?Chave=" + Convert.ToBase64String(bytesToEncode));
        }
        ...
        private void CarregarGrid()
        {
            ...
            try
            {
                if (ObjetoTurmaPesquisa != null)
                {
                    ...
                    {//ConsultarTurma
                        qtGradeSerie = RN.GradeSerie.ConsultarTurmaNotas(ObjetoTurmaPesquisa.Ano, ObjetoTurmaPesquisa.Periodo, string.Empty,
        ...
        private string MontarQueryString(Techne.Lyceum.RN.Turma.DadosTurma turma)
        {
            ...
            if (turma != null)
            {
                ...
                queryString += "&nucleo=" + turma.Regional;
