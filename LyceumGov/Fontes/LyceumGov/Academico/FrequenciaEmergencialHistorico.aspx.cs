...
{
    [
    NavUrl("~/Academico/FrequenciaEmergencialHistorico.aspx"),
    ControlText("FrequenciaEmergencialHistorico"),
    Title("Controle Frequência Histórico - Emergencial"),
]
    public partial class FrequenciaEmergencialHistorico : TPage
    {
        public object Lista(object turma, object ano, object periodo, object mes)
        {
            ...
            {
                return rnMatricula.ListaMatriculasElegiveisHistoricoPor(turmafiltro, Convert.ToInt32(anofiltro), Convert.ToInt32(periodofiltro), Convert.ToInt32(mesfiltro));
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                RN.Turmas.PeriodoFrequenciaAluno rnPeriodoFrequenciaAluno = new Techne.Lyceum.RN.Turmas.PeriodoFrequenciaAluno();
        ...
        private void CarregaTurma()
        {
            ...
            {
                ddlTurma.DataSource = rnTurma.ListaTurmaAbertaFinalizadaEnsinoMedioPor(Convert.ToInt32(ddlAno.SelectedValue), Convert.ToInt32(ddlPeriodo.SelectedValue), tseUnidadeResponsavel.DBValue.ToString());
        ...
        {
            RN.Turmas.FrequenciaTurma rnFrequenciaTurma = new Techne.Lyceum.RN.Turmas.FrequenciaTurma();
        ...
        protected void btnSalvar_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                RN.Turmas.FrequenciaTurma rnFrequenciaTurma = new Techne.Lyceum.RN.Turmas.FrequenciaTurma();
                List<RN.Turmas.Entidades.FrequenciaAluno> lsAlunos = new List<RN.Turmas.Entidades.FrequenciaAluno>();
                RN.Turmas.Entidades.FrequenciaAluno dados = new Techne.Lyceum.RN.Turmas.Entidades.FrequenciaAluno();
                RN.Turmas.Entidades.FrequenciaTurma dadosTurma = new Techne.Lyceum.RN.Turmas.Entidades.FrequenciaTurma();
                    ...
                    for (int i = 1; i < 31; i++)
                    {
                        ...
                        if (DateTime.TryParse(valor, out resultado))
                        {
                            ...
                            if (diasLetivos.Contains(data))
                            {
                                ...
                                {
                                    dados = new Techne.Lyceum.RN.Turmas.Entidades.FrequenciaAluno();                                   
                ...
                validacao = rnFrequenciaTurma.Valida(dadosTurma, lsAlunos, listaAlunos, true);
