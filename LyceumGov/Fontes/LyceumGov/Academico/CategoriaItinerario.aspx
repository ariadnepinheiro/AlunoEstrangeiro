<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="CategoriaItinerario.aspx.cs" Inherits="Techne.Lyceum.Net.Academico.CategoriaItinerario" %>

<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="cphFormulario" runat="server">
    <asp:ObjectDataSource ID="odsCategoria" runat="server" TypeName="Techne.Lyceum.Net.Academico.CategoriaItinerario"
    ...
    <dxwgv:ASPxGridView ID="grdCategoria" runat="server" DataSourceID="odsCategoria"
        OnAfterPerformCallback="grdCategoria_AfterPerformCallback" KeyFieldName="CATEGORIAITINERARIOFORMATIVOID"
        AutoGenerateColumns="false" ClientInstanceName="grdCategoria" OnInitNewRow="grdCategoria_InitNewRow"
        OnStartRowEditing="grdCategoria_StartRowEditing" OnRowInserting="grdCategoria_RowInserting"
        OnRowUpdating="grdCategoria_RowUpdating" OnRowDeleting="grdCategoria_RowDeleting"
        Width="700px">
                ...
                <HeaderCaptionTemplate>
                    <div style="text-align: center">
                        <img id="btnNovoGrid" runat="server" alt="Novo" style="cursor: pointer" src="../img/bt_novo.png"
                            onclick="grdCategoria.AddNewRow();" />
                    </div>
                </HeaderCaptionTemplate>
