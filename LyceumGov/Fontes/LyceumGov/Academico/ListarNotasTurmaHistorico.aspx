<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="ListarNotasTurmaHistorico.aspx.cs" Inherits="Techne.Lyceum.Net.Academico.ListarNotasTurmaHistorico" %>
...
<asp:Content ID="cListarTurma" ContentPlaceHolderID="cphFormulario" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <tweb:TSearchBox ID="tseUnidadeResponsavel" runat="server" Caption="" Key="unidade_ens"
                            MaxLength="20" ArgumentColumns="50" Columns="10" Argument="nome_comp" SqlSelect=" SELECT unidade_ens, nome_comp, setor, cgc, situacao,ua_atual from VW_UNIDADE_ENSINO_SITUACAO "
    ...
    <dxwgv:ASPxGridView ID="grdGradeSerie" runat="server" KeyFieldName="grade_id" ClientInstanceName="grdGradeSerie"
        ...
        Font-Names="Verdana" Font-Size="Small" Width="90%" OnSelectionChanged="grdGradeSerie_SelectionChanged"
        SkinID="NoConfirmDelete">
        <SettingsBehavior AllowMultiSelection="False" ProcessSelectionChangedOnServer="True" />
        <SettingsText EmptyDataRow="Não existem dados." />
        <Columns>
            <dxwgv:GridViewCommandColumn VisibleIndex="0" ButtonType="Image" Width="20px">
            ...
            <dxwgv:GridViewDataTextColumn FieldName="ano" VisibleIndex="1" Caption="Ano" Width="40px"
                CellStyle-HorizontalAlign="Center">
                <PropertiesTextEdit MaxLength="5">
                </PropertiesTextEdit>
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="semestre" VisibleIndex="2" Caption="Período"
                Width="50px" CellStyle-HorizontalAlign="Center">
                <PropertiesTextEdit MaxLength="5">
                </PropertiesTextEdit>
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataTextColumn FieldName="grade_id" VisibleIndex="16" Visible="false">
            </dxwgv:GridViewDataTextColumn>
        </Columns>
