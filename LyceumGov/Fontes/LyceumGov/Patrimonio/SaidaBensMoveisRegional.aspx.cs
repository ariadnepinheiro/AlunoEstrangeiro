...
{
    [NavUrl("~/Patrimonio/SaidaBensMoveisRegional.aspx"), ControlText("Saída Bens Móveis - Regional"), Title("Saída Bens Móveis - Regional")]
    public partial class SaidaBensMoveisRegional : TPage
    {
        ...
        protected void btnPesquisar_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    if ((!tseUnidadeAdministrativa.DBValue.IsNull && tseUnidadeAdministrativa.IsValidDBValue) && !ddlAno.SelectedValue.IsNullOrEmptyOrWhiteSpace() && !ddlMesInicial.SelectedValue.IsNullOrEmptyOrWhiteSpace() && !ddlMesFinal.SelectedValue.IsNullOrEmptyOrWhiteSpace())
                    {
        ...
        protected void btnExportarPDF_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (divPrincipal.Visible)
                {
                    ...
                    exportaPdf.ExportaHtmlSimplesOrientacaoPaisagemPor(html.ToString(), "SaidaBensMoveis_" + tseUnidadeAdministrativa.DBValue.ToString() + "_" + ddlMesInicial.SelectedItem.Text.ToUpper() + "_" + ddlMesFinal.SelectedItem.Text.ToUpper());
                }
                else
                {
