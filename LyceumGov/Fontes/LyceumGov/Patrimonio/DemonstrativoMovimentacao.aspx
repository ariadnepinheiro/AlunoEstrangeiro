<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="DemonstrativoMovimentacao.aspx.cs" Inherits="Techne.Lyceum.Net.Patrimonio.DemonstrativoMovimentacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <div id="divPrincipal" runat="server" visible="false">
        <table align="center">
            ...
            <tr align="center">
                <td align="center" style="font-family: Tahoma, Geneva, sans-serif; font-size: 11px; border-color: #000000;
                    font-weight: bold;">
