<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="InventarioExistenciasFisicas.aspx.cs" Inherits="Techne.Lyceum.Net.Patrimonio.InventarioExistenciasFisicas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlFiltro" GroupingText="Informe os dados para pesquisar as existências físicas"
        Width="800px">
        <table>
            <tr>
