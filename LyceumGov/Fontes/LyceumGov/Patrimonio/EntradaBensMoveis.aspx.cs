...
{
    [NavUrl("~/Patrimonio/EntradaBensMoveis.aspx"), ControlText("Entrada Bens Móveis - Unidade"), Title("Entrada Bens Móveis - Unidade")]

    public partial class EntradaBensMoveis : TPage
    {
            ...
            try
            {
                ...
                if (geral.Rows.Count > 0)
                {
                    ...
                    {                        
                        ...
                        int bemId = Convert.ToInt32(item["BEMID"].ToString());
                        int primeiraMovimentacao = rnMovimentacao.ObtemPrimeiraMovimentacaoPor(bemId);
                        string valorInicial;
        ...
        protected void btnExportarPDF_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (divPrincipal.Visible)
                {
                    ...
                    exportaPdf.ExportaHtmlSimplesOrientacaoPaisagemPor(html.ToString(), "EntradaBensMoveis_" + tseUACedente.DBValue.ToString() + "_" + ddlMesInicial.SelectedItem.Text.ToUpper() + "_" + ddlMesFinal.SelectedItem.Text.ToUpper());
                }
                else
                {
