<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="SaidaBensMoveis.aspx.cs" Inherits="Techne.Lyceum.Net.Patrimonio.SaidaBensMoveis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlFiltro" GroupingText="Informe os dados para pesquisar as saídas"
        Width="800px">
        <table>
            <tr>
