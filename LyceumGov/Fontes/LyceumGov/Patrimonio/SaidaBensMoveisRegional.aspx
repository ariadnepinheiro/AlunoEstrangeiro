<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="SaidaBensMoveisRegional.aspx.cs" Inherits="Techne.Lyceum.Net.Patrimonio.SaidaBensMoveisRegional" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlTipoFiltro" GroupingText="Informe os dados para pesquisar as saídas"
        Width="800px">
        <table>
            <tr>
                <td>
            ...
            <table>
                ...
                <tr>
                    <asp:Panel runat="server" ID="pnlUnidade" Width="800px" Visible="false">
                        ...
                        <td colspan="2">
                        <tweb:TSearchBox ID="tseUnidadeAdministrativa" runat="server" Caption="" Key="ua_atual"
                                MaxLength="20" ArgumentColumns="50" Columns="10" Argument="nome" SqlSelect=" SELECT ua_atual, nome, uar.setor, ua_antiga from VW_UNIDADE_ADMINISTRATIVA_REGIONAL uar join HADES..VW_SETOR s on uar.SETOR = s.SETOR  inner join LY_UNIDADE_ENSINO lyue on lyue.SETOR = uar.SETOR inner join TCE_REGIONAL reg on reg.ID_REGIONAL = lyue.ID_REGIONAL "
                                SqlWhere=" reg.ID_REGIONAL = isnull( #tseRegional# ,0)" GridWidth="850px" OnChanged="tseUnidadeAdministrativa_Changed" SqlOrder="ua_atual">
                                <GridColumns>              
