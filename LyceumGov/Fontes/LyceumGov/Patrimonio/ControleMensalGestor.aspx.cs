...
{
    [NavUrl("~/Patrimonio/ControleMensalGestor.aspx"), ControlText("Controle Mensal do Gestor - Anexo II - Geral"), Title("Controle Mensal do Gestor - Anexo II - Geral")]
    public partial class ControleMensalGestor : TPage
    {
        ...
        private void MontarRelatorio()
        {
            try
            {
                ...
                geral = rnBem.ObtemControleMensalGestorPor(Convert.ToInt32(ddlAno.SelectedValue), Convert.ToInt32(ddlMes.SelectedValue));
