<%@ Page Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true" CodeBehind="AprovacaoDespesaEmLotePorPeriodo.aspx.cs" Inherits="Techne.Lyceum.Net.PrestacaoContas.AprovacaoDespesaEmLotePorPeriodo" %>
        ...
        <asp:UpdatePanel ID="upFiltro" runat="server">
            <ContentTemplate>
                ...
                <table style="table-layout: fixed" width="580">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label Font-Names="Verdana" ID="Label3" SkinID="lblObrigatorio" runat="server" Text="Período de Prestação de Contas:*"></asp:Label>
                        </td>
                        <td>
                            <tweb:TSearchBox ID="tsePeriodoReferencia" runat="server" Argument="DESCRICAO" ArgumentColumns="50"
                                MaxLength="20" Columns="10" AutoPostBack="True" Caption="" SqlOrder="ANO, MESINICIAL DESC" DataType="Number"
                    ...
                    <tr>
                        <td align="right">&nbsp;</td>
                        <td>
                            <asp:Checkbox ID="chkMostrarComExigenciasSemAnalise" runat="server" Text="Mostrar todos com exigências pendentes" />
                        </td>
                    </tr>
                    <tr>
    ...
    <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="plaGrid" runat="server" style="display: none">
                ...
                <asp:ObjectDataSource ID="odsEvento" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.AprovacaoDespesaEmLotePorPeriodo" SelectMethod="ListaDespesa">
                    <SelectParameters>
                        <asp:Parameter Name="censo" DbType="String" />
                        <asp:Parameter Name="inicio" DbType="DateTime" />
                        <asp:Parameter Name="fim" DbType="DateTime" />
                        <asp:Parameter Name="mostrarSomenteComTodasExigenciasAnalisadas" DbType="Boolean" />
                    </SelectParameters>
                ...
                <div style="height: 25px; margin-left: 10px;" class="qtd-despesa">
                    <span>Qtd. de Despesas Pendentes: </span><asp:Label ID="lblQtdPendente" runat="server" Text="0" CssClass="qtd-despesa"></asp:Label>
                </div>
                <div style="height: 25px; margin-left: 10px;" class="qtd-despesa">
                ...
                <dxwgv:ASPxGridView ID="grdDespesas" runat="server" DataSourceID="odsEvento"
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Total Exigências" FieldName="TOTALEXIGENCIAS" VisibleIndex="7">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Total Exigências Analisadas" FieldName="TOTALEXIGENCIASANALISADAS" VisibleIndex="8">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Total Exigências Rejeitadas" FieldName="TOTALEXIGENCIASREJEITADAS" VisibleIndex="9">
                        </dxwgv:GridViewDataTextColumn>
