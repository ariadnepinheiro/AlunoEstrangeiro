<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true" CodeBehind="MotivoExigenciaCredDeb.aspx.cs" Inherits="Techne.Lyceum.Net.PrestacaoContas.MotivoExigenciaCredDeb" %>
...
<asp:ObjectDataSource ID="odsTipoVeiculo" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.MotivoExigenciaCredDeb"
        SelectMethod="Lista" InsertMethod="Insert" UpdateMethod="Update"
        DeleteMethod="Delete" >
    <DeleteParameters>
        <asp:Parameter Name="TIPOEXIGENCIAOPERACAOID" Type="Object" />
    </DeleteParameters>
    <UpdateParameters>
        <asp:Parameter Name="DESCRICAO" Type="Object" />
        <asp:Parameter Name="ATIVO" Type="Object" />
        <asp:Parameter Name="NECESSITAANEXO" Type="Object" />
        <asp:Parameter Name="TIPOEXIGENCIAOPERACAOID" Type="Object" />
    </UpdateParameters>
    <InsertParameters>
        <asp:Parameter Name="DESCRICAO" Type="Object" />
    ...
    <dxwgv:ASPxGridView ID="grdTipoVeiculo" runat="server" DataSourceID="odsTipoVeiculo"
        KeyFieldName="TIPOEXIGENCIAOPERACAOID" AutoGenerateColumns="false" ClientInstanceName="grdTipoVeiculo"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="TIPOEXIGENCIAOPERACAOID"
         ...
         <dxwgv:GridViewDataCheckColumn Caption="Anexo?*" FieldName="NECESSITAANEXO" VisibleIndex="4"
                    Width="120px">
