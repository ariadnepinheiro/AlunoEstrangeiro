<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Modulos/LyceumMaster.Master"
    CodeBehind="PainelFinanceiroTotal.aspx.cs" Inherits="Techne.Lyceum.Net.PrestacaoContas.PainelFinanceiroTotal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel ID="pnBusca" runat="server" GroupingText="Informações do Painel de Saldo Total"
        Width="617px">
    ...
    <div class="divEditBlock" style="width: 950px;">
        <asp:Label runat="server" ID="lblBlocoAluno" Text="Painel de Saldo Total" SkinID="BcTitulo" />
    ...
    <br />
    <asp:ObjectDataSource ID="odsMerenda" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.PainelFinanceiroTotal"
    ...
    <asp:ObjectDataSource ID="odsManutencao" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.PainelFinanceiroTotal"
    ...
    <asp:ObjectDataSource ID="odsOutrosProjetos" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.PainelFinanceiroTotal"
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Orientação:" Width="950px">
        Serão exibidadas todas as despesas, elas estando aprovados ou não.<br />
        <br />
        Os registros com a indicação <b>"CÓDIGO:"</b>, seguida de um número, representam
        as notas ainda não submetidas para análise.
    </asp:Panel>
    <br />
    <table id="tblPainel" runat="server" visible="false">
        ...
        <tr>
            <td colspan="3">
                <b>Saldo bancário calculado:</b><asp:Label ID="lblSaldoBancarioTeorico" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
