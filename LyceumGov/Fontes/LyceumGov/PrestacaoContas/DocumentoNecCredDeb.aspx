<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true" CodeBehind="DocumentoNecCredDeb.aspx.cs" Inherits="Techne.Lyceum.Net.PrestacaoContas.DocumentoNecCredDeb" %>
...
<asp:ObjectDataSource ID="odsTipoVeiculo" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.DocumentoNecCredDeb"
    ...
    <dxwgv:ASPxGridView ID="grdTipoVeiculo" runat="server" DataSourceID="odsTipoVeiculo"
        KeyFieldName="DOCUMENTOSNECESSARIOSOPERACOESID" AutoGenerateColumns="false" ClientInstanceName="grdTipoVeiculo"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="ID" Name="ID" VisibleIndex="1" FieldName="DOCUMENTOSNECESSARIOSOPERACOESID"
           ...
           <dxwgv:GridViewDataTextColumn Caption="Data Cadastro"  Name="DataCadastro" VisibleIndex="3"
                FieldName="DATACADASTRO" Width="200px" ReadOnly="True">
                <PropertiesTextEdit MaxLength="100">
                </PropertiesTextEdit>
            </dxwgv:GridViewDataTextColumn>
