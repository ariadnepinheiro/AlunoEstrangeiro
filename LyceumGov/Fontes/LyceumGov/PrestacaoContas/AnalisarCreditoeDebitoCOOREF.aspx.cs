...
{
    [NavUrl("~/PrestacaoContas/AnalisarCreditoeDebitoCOOREF.aspx"), ControlText("Analisar Crédito e Débito Geral"), Title("Analisar Crédito e Débito Geral")]
    public partial class AnalisarCreditoeDebitoCOOREF : TPage
    {
        ...
        protected void grdRegistro_AfterPerformCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewAfterPerformCallbackEventArgs e)
        {
            if (e.CallbackName.Equals("SELECTION"))
            {
              ...
              //  var retstatus = rnOperacao.RetornaStatus(operacaoId);                
                ...
                ASPxWebControl.RedirectOnCallback("AnalisareVerificarCreditoeDebitoCOOREF.aspx?OperacaoID=" + operacaoId);
