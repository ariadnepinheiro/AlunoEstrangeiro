...
{
    [NavUrl("~/PrestacaoContas/PainelFinanceiroTotal.aspx"), ControlText("Painel de Saldo Total"), Title("Painel de Saldo Total")]
    public partial class PainelFinanceiroTotal : TPage
    {
        ...
        public object ListaMerenda(object censo, object inicio, object fim, object referenciaid)
        {
            ...
            {
                dtDados = painelFinanceiro.RetornaDadosMerendaTotal(censo.ToString(), Convert.ToDateTime(inicio).Date, Convert.ToDateTime(fim).Date, Convert.ToInt32(referenciaid));
        ...
        public object ListaManutencao(object censo, object inicio, object fim, object referenciaid)
        {
            ...
            if (!string.IsNullOrEmpty(censo.ToString()) != null && !string.IsNullOrEmpty(inicio.ToString()) != null && !string.IsNullOrEmpty(fim.ToString()) != null)
            {
                ...
                dtDados = painelFinanceiro.RetornaDadosManutencaoTotal(censo.ToString(), Convert.ToDateTime(inicio).Date, Convert.ToDateTime(fim).Date, Convert.ToInt32(referenciaid));
        ...
        public object ListaOutrosProjetos(object censo, object inicio, object fim, object referenciaid)
        {
            ...
            if (!string.IsNullOrEmpty(censo.ToString()) != null && !string.IsNullOrEmpty(inicio.ToString()) != null && !string.IsNullOrEmpty(fim.ToString()) != null)
            {
                dtDados = painelFinanceiro.RetornaDadosOutrosProjetosTotal(censo.ToString(), Convert.ToDateTime(inicio).Date, Convert.ToDateTime(fim).Date, Convert.ToInt32(referenciaid));
