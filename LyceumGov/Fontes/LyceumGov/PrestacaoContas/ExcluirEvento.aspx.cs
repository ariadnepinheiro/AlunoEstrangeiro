...
{
    [NavUrl("~/PrestacaoContas/ExcluirEvento.aspx"), ControlText("Excluir Despesa"), Title("Excluir Despesa")]
    public partial class ExcluirEvento : TPage
    {
        ...
        protected void btnNovo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblMensagem.Text = "Selecione a UNIDADE DE ENSINO e o PROJETO / PROGRAMA para cadastrar uma nova despesa.";
                }
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblMensagem.Text = "Despesa atualizada com sucesso.";
                }
        ...
        private void ZerarCamposDespesaComum()
        {
            try
            {
                ...
                tbXML.Visible = true;
                txtJustificativaExclusao.Text = string.Empty;
            }
            catch
            {
                throw;
        ...
        private ValidacaoDados SalvaPequenaDespesaComTranslado()
        {
            try
            {
                ...
                evento.Servidores = Servidores_DCTS.ToList();
        ...
        private ModoTelaEnum ModoTela
        {
            ...
            set
            {
                ...
                var tabExcluir = pcCadastrarEvento.TabPages.FindByName("tabExcluir");
                ...
                switch (value)
                {
                    ...
                    case ModoTelaEnum.ConsultaDespesaComumExistente:
                        ...
                        tabExcluir.ClientVisible = Convert.ToBoolean(hdnPodeExcluir.Value);
                    ...
                    case ModoTelaEnum.InserirNovo:
                        ...
                        tabExcluir.ClientVisible = false;
        ...
        protected void btnExcluirDespesa_Click(object sender, EventArgs e)
        {
            try
            {
                RN.PrestacaoContas.Evento rnEvento = new Techne.Lyceum.RN.PrestacaoContas.Evento();
                var verificaenviosei = rnEvento.VerificaEnvioSEI(Convert.ToInt32(tseEvento.DBValue));
                if (verificaenviosei)
                    throw new Exception("Não é possível excluir esta despesa porque o Formulário SEI já foi gerado.");

                this.pucConfirmarxcluir.ShowOnPageLoad = true;
            }
            catch (Exception ex)
            {
                lblMensagem.Text = ex.Message;
        ...
        protected void btnSim_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                validacao = rnEvento.ValidaRemocaoTotal(Convert.ToInt32(tseEvento.DBValue), txtJustificativaExclusao.Text, User.Identity.Name);

                if (validacao.Valido)
                {
                    rnEvento.RemoveTotal(Convert.ToInt32(tseEvento.DBValue), txtJustificativaExclusao.Text, User.Identity.Name);

                    lblMensagem.Text = "Exclusão realizada com sucesso.";
                ...
                this.pucConfirmarxcluir.ShowOnPageLoad = false;
            }
