<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastrarEvento.aspx.cs"
    MasterPageFile="~/Modulos/LyceumMaster.Master" Inherits="Techne.Lyceum.Net.PrestacaoContas.CadastrarEvento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
            ...
            <tr>
                ...
                <td width="600">
                    <tweb:TSearchBox ID="tsePlanoTrabalho" runat="server" Argument="descricao" Key="PLANOTRABALHOID"
                        ...
                        <GridColumns><tweb:TSearchBoxColumn Caption="Código" FieldName="PLANOTRABALHOID" Width="10%" /><tweb:TSearchBoxColumn Caption="Descrição" FieldName="DESCRICAO" Width="90%" /><tweb:TSearchBoxColumn Caption="Finalidade" FieldName="FINALIDADE" Width="90%" /></GridColumns>
                    </tweb:TSearchBox>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td width="600">
                    <tweb:TSearchBox ID="tsePeriodoPrestacaoContas" runat="server" 
                        ...
                        SqlSelect="select periodoreferenciaid, mesinicial, mesfinal, referencia, datalimiteprestacaocontas, datalimiteanalise, descricao, datalimitedespesas from prestacaocontas.vw_periodoreferencia"
                        ...
                        <GridColumns>
                            ...
                            <tweb:TSearchBoxColumn Caption="Data Limite Despesas" FieldName="datalimitedespesas" Visible="false" />
                        </GridColumns>
                    </tweb:TSearchBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="600">
                    <tweb:TSearchBox ID="tseEvento" runat="server" Caption="" Key="EVENTOID" Argument="DESCRICAO"
                        ...
                        SqlSelect=" SELECT ESCOLA, PERIODOREFERENCIAID, NUMEROEVENTO, FINALIDADE, DATAPAGAMENTO, DATAPAGAMENTOFORMATADA, PLANOTRABALHOID, NUMERONOTAFISCAL FROM PRESTACAOCONTAS.VW_EVENTO_PERIODO "
                        OnChanged="tseEvento_Changed" SqlWhere=" PERIODOREFERENCIAID = #tsePeriodoPrestacaoContas# " Enabled="false">
                        <GridColumns><tweb:TSearchBoxColumn Caption="Código" FieldName="EVENTOID" Width="5%" />
                        <tweb:TSearchBoxColumn Caption="PERIODOREFERENCIAID" FieldName="PERIODOREFERENCIAID" Width="10%" />
                        ...
                        <tweb:TSearchBoxColumn Caption="Dt.Pagamento" FieldName="DATAPAGAMENTOFORMATADA" Width="15%" />
    ...
    <asp:HiddenField ID="hdnEditaData" runat="server" />
    <asp:Label ID="lblMensagem" runat="server" SkinID="lblMensagem"></asp:Label>
    <asp:Label ID="lblStatus" runat="server" SkinID="lblMensagem"></asp:Label>
    <br />
    <div class="divEditBlock" style="width: 950px;">
        <asp:ImageButton ID="btnEditar" runat="server" SkinID="BcEditar" Visible="false"
            OnClick="btnEditar_Click" />
        <asp:ImageButton ID="btnEditarDatas" runat="server" SkinID="BcEditarDatas" Visible="false"
            OnClick="btnEditarDatas_Click" />
                    ...
                    <ContentCollection>
                        <dxw:ContentControl ID="ContentControl4" runat="server">
                            ...
                            <dxwgv:ASPxGridView runat="server" ID="grdExigenciaEvento" ClientInstanceName="grdExigenciaEvento"
                                ...
                                KeyFieldName="EXIGENCIAEVENTOID" OnHtmlRowCreated="grdExigenciaEvento_HtmlRowCreated">
                                <Settings ShowFilterRow="false" ShowFilterRowMenu="false" />
                                <SettingsEditing Mode="Inline" />
