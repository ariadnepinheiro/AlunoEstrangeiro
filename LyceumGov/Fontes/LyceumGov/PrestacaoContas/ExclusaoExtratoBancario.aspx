<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExclusaoExtratoBancario.aspx.cs" MasterPageFile="~/Modulos/LyceumMaster.Master" Inherits="Techne.Lyceum.Net.PrestacaoContas.ExclusaoExtratoBancario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel runat="server" ID="Panel1" GroupingText="Informações do Extrato Bancário" Width="800px">
        <table width="800">
            ...
            <tr>
                ...
                <td width="690">
                    <asp:ObjectDataSource ID="odsAno" runat="server" SelectMethod="ListaAno" TypeName="Techne.Lyceum.Net.PrestacaoContas.ExclusaoExtratoBancario">
    ...
    <asp:ObjectDataSource ID="odsExtratoBancario" runat="server" TypeName="Techne.Lyceum.Net.PrestacaoContas.ExclusaoExtratoBancario" 
        SelectMethod="ListaExtratoBancario"
        DeleteMethod="DeleteExtratoBancario">
        <SelectParameters>
    ...
    <dxwgv:ASPxGridView runat="server" ID="grdExtratoBancario"
        ...
        KeyFieldName="EXTRATOBANCARIOID" 
        OnFocusedRowChanged="grdExtratoBancario_FocusedRowChanged"
        OnRowDeleting="grdExtratoBancario_RowDeleting">
        ...
        <Columns>
            <dxwgv:GridViewCommandColumn VisibleIndex="0" ButtonType="Image" Caption="Remover" Width="50px">
                <DeleteButton Visible="True" Text="Remover">
                    <Image Url="../img/bt_exclui2.png" />
                </DeleteButton>
            </dxwgv:GridViewCommandColumn>
            <dxwgv:GridViewDataColumn Caption="Visualizar" VisibleIndex="0" Width="40px">
                <DataItemTemplate>
                ...
                <ContentCollection>
                    <dxw:ContentControl ID="ContentControl2" runat="server">
                        ...
                        <asp:ObjectDataSource ID="odsTipoExigenciaExtrato" runat="server"
                            TypeName="Techne.Lyceum.Net.PrestacaoContas.ExclusaoExtratoBancario" 
