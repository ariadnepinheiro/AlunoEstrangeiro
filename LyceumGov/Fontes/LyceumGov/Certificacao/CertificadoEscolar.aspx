<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="CertificadoEscolar.aspx.cs" Inherits="Techne.Lyceum.Net.Certificacao.CertificadoEscolar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    <div>
                ...
                <tr>
                    ...
                    <td>
                        <tweb:TSearch ID="tseAluno" runat="server" SettingsTypeName="Techne.Lyceum.RN.Query.QueryAluno"
                            AutoPostBack="true" OnTextChanged="tseAluno_TextChange">
                        </tweb:TSearch>
                    </td>
                    <td>
                        <br />
                    ...
                    <td>
                        <asp:DropDownList ID="ddlTipoConclusao" runat="server" DataTextField="DESCRICAO"
                            DataValueField="TIPOCONCLUSAOID" AutoPostBack="false">
                        </asp:DropDownList>
                    </td>
                    <td align="right">
                        <asp:Label runat="server" ID="lblTipoDocumento" SkinID="lblTipoDocumento" Text="Tipo de Documento*:"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlTipoDocumento" runat="server" AutoPostBack="false">
                            <asp:ListItem Text="Selecione" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="Certificado Escolar" Value="3"></asp:ListItem>
            ...
            <hr id="Hr10" style="margin: 1px" />
              <table style="width: 100%; border-spacing: 0;" cellpadding="0" cellspacing="0" border="0">
                <tr>                   
                   <td>
                    <br />
                    <asp:TextBox ID="txtObservacao" runat="server" MaxLength="8000" TextMode="MultiLine" Height="79px" Width="750px"></asp:TextBox>
                   </td>
                </tr>
              </table>    --%>
            <br />
        ...
        <br />
        <br />
        <%--aqui estavam os botões--%>
        <asp:Button ID="btnGerarDocumento" runat="server" Text="Gerar Documento" Font-Size="Small"
            Visible="false" OnClick="btnGerarDocumento_Click" />
