...
namespace Techne.Lyceum.Net.Curriculo
{
	public partial class ListarTurma
	{
        public override void HelpInit(HelpData help)
        {
            ...
            help.Oper.Add("Para consultar, cadastrar ou alterar turmas é necessário selecionar o ano, a situação e unidade de esnino.");
            ...
            help.Oper.Add("• Ano: Ano referente à turma. (Tabela: Ano Letivo, cujo filtro é ano maior ou igual à 2010)");
            help.Oper.Add("• Período: Período referente à turma. (Tabela: Ano Letivo, cujo filtro é Ano)");
