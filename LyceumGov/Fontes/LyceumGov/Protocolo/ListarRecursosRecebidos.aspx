<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="ListarRecursosRecebidos.aspx.cs" Inherits="Techne.Lyceum.Net.Protocolo.ListarAnaliseRecursoRecebido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="false">
        <dxwgv:ASPxGridView ID="grdProtocolo" runat="server" KeyFieldName="PROTOCOLOPRESTACAOID"
            ...
            AutoGenerateColumns="False" OnAfterPerformCallback="grdProtocolo_AfterPerformCallback" 
            Width="100%" SkinID="NoConfirmDelete">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="ID" FieldName="PROTOCOLOPRESTACAOID" VisibleIndex="0" Visible="false">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Censo" FieldName="UNIDADEENSINOID" VisibleIndex="1" Visible="false">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Regional" FieldName="REGIONALID" VisibleIndex="2" Visible="false">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Ano" FieldName="ANO" VisibleIndex="3">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Temporalidade" FieldName="TEMPORALIDADE" VisibleIndex="4">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Processo" FieldName="PROCESSO" VisibleIndex="5">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Número de Folhas" FieldName="NUMEROFOLHAS" VisibleIndex="6">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="SITUACAOPROTOCOLOID" FieldName="SITUACAOPROTOCOLOID" VisibleIndex="7" Visible="false">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Situação" FieldName="SITUACAO" VisibleIndex="8">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="TIPOPROTOCOLOID" FieldName="TIPOPROTOCOLOID" VisibleIndex="9" Visible="false">
                </dxwgv:GridViewDataTextColumn>
                ...
                <dxwgv:GridViewDataDateColumn Caption="Data do Processo" FieldName="DATAPROCESSO" VisibleIndex="13">
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataDateColumn Caption="Data Cadastro" FieldName="DATACADASTRO" VisibleIndex="14">
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataDateColumn Caption="Data Alteração" FieldName="DATAALTERACAO" VisibleIndex="15" Visible="false">
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataTextColumn Caption="Usuário" FieldName="USUARIOID" VisibleIndex="16" Visible="false">
                </dxwgv:GridViewDataTextColumn>
            </Columns>
