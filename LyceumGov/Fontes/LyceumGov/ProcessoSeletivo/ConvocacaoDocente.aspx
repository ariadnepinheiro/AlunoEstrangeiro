<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="ConvocacaoDocente.aspx.cs" Inherits="Techne.Lyceum.Net.ProcessoSeletivo.ConvocacaoDocente" %>
...
<asp:Content ID="conConvocacao" ContentPlaceHolderID="cphFormulario" runat="server">
            ...
            <tr>
                ...
                <td>
                    <tweb:TSearchBox ID="tseConcurso" runat="server" Key="concurso" Argument="descricao"
                        ...
                        SqlWhere="tipo = 'Contrato'" OnChanged="tseConcurso_Changed" SqlOrder=" ano desc">
                        <GridColumns>
            ...
            <tr>
                ...
                <td colspan="3">
					...
					INNER JOIN REGIONAL RG ON RG.POLO = UE.ID_REGIONAL " SqlWhere=" SIT_FUNCIONAMENTO='EmAtividade' and RG.POLO = #tseRegional#"
                        MaxLength="20" ArgumentColumns="50" Columns="30" SqlOrder="NOME" DataType="Varchar"
                        OnChanged="tseMunicipioProc_Changed" AutoPostBack="true" GridWidth="800px">
                        <GridColumns>
    ...
    <asp:Panel ID="pnCampos" runat="server" GroupingText="Dados do Processo Seletivo"
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblCota" runat="server" Text="Lista para Convocação:* " SkinID="lblObrigatorio"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlCotas" runat="server" DataValueField="COTAID" DataTextField="SIGLA"
                        AutoPostBack="true" OnSelectedIndexChanged="ddlCotas_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <asp:ObjectDataSource ID="odsSelecao" TypeName="Techne.Lyceum.Net.ProcessoSeletivo.ConvocacaoDocente"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlCotas" Name="cota" PropertyName="SelectedValue" />
        </SelectParameters>
    ...
    <asp:Panel ID="pnSelecao" runat="server" GroupingText="Seleção*" Visible="false"
        ...
        <dxwgv:ASPxGridView ID="grdSelecao" runat="server" AutoGenerateColumns="False" SkinID="NoConfirmDelete"
            DataSourceID="odsSelecao" ClientInstanceName="grdSelecao" KeyFieldName="matricula"
            Width="700px">
                ...
                <dxwgv:GridViewDataComboBoxColumn Caption="Situação" FieldName="status" VisibleIndex="5"
                    ...
                    <PropertiesComboBox>
                        <Items>
                            ...
                            <dxe:ListEditItem Text="Proposta de Contrato Temporário &#8211; Aguardando Avaliação"
                                Value="3" />
                            <dxe:ListEditItem Text="Aguardando Remessa &#8211; Proposta Aprovada" Value="4" />
                            <dxe:ListEditItem Text="Desistente" Value="5" />
                            <dxe:ListEditItem Text="Reprovado" Value="6" />
                            <dxe:ListEditItem Text="Aprovado" Value="7" />
                            <dxe:ListEditItem Text="Cancelado" Value="8" />
                            <dxe:ListEditItem Text="Desativado" Value="9" />
        ...
        <br />
<%--        <asp:Label ID="Label2" runat="server" Text="* Caso existam outras convocações para o mesmo dia/hora de apresentação, serão listados todos os convocados selecionados nos filtros(Processo Seletivo/Regional/Município/Disciplina)."
