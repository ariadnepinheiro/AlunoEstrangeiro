<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="ConsultaCandidato.aspx.cs" Inherits="Techne.Lyceum.Net.Matricula.ConsultaCandidato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphFormulario" runat="server">
    ...
    <asp:Panel ID="pnlBuscadados" runat="server" GroupingText="Preencha os dados abaixo para realizar a busca"
        ...
        <table>
            ...
            <tr>
                <td style="text-align: right">
                    <asp:Label ID="Label7" runat="server" Text="Nome da Mãe:"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td style="text-align: right">
                    <asp:Label ID="Label36" runat="server" Text="Nome do Pai:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPai" runat="server" MaxLength="100" onkeypress="return nomeSemNum(event);"
                        Width="450px" />
                </td>
                <td colspan="2">
                    <asp:CheckBox ID="chkNaoDeclarPaiBusca" runat="server" AutoPostBack="true" OnCheckedChanged="chkNaoDeclarPaiBusca_CheckedChanged"
                        Text="Não Declarado" />
                </td>
            </tr>
            <tr>
                <td style="text-align: right">
                    <asp:Label ID="Label37" runat="server" Text="CPF Responsável:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCPFResponsavel" MaxLength="14" runat="server" SkinID="numerico"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="text-align: right">
                ...
                <td>
                    <asp:TextBox ID="txtNumInscricao" runat="server" MaxLength="9" onkeypress="return onlyNumbers(event);"
                        Width="250px" />
                </td>
            </tr>
            <tr>
                 <td style="text-align: right">
                    <asp:CheckBox ID="chkFonetizarCandidato" runat="server" AutoPostBack="true" OnCheckedChanged="chkFonetizarCandidato_CheckedChanged"
                        Text="Fonetizar" />
                    </td>
                </tr>
            <tr>
    ...
    <div id="dvGeral" runat="server" visible="false">
        ...
        <br />
        <asp:ObjectDataSource ID="odsOpcao" TypeName="Techne.Lyceum.Net.Matricula.ConsultaCandidato"
        ...
        <div id="dvFase1" runat="server" visible="false">
            <asp:ObjectDataSource ID="odsFase1" TypeName="Techne.Lyceum.Net.Matricula.ConsultaCandidato"
        ...
        <br />
        <asp:ObjectDataSource ID="odsOpcoesFinalizadas" TypeName="Techne.Lyceum.Net.Matricula.ConsultaCandidato"
