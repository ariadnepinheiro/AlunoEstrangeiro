<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/LyceumMaster.Master" AutoEventWireup="true"
    CodeBehind="RetornoNaoConfirmado.aspx.cs" Inherits="Techne.Lyceum.Net.Matricula.RetornoNaoConfirmado" %>
            ...
            <tr>
                ...
                <td>
                    <tweb:TSearchBox ID="tseUnidadeResponsavel" runat="server" Caption="" Key="unidade_ens"
                        MaxLength="20" ArgumentColumns="50" Columns="10" Argument="nome_comp" SqlSelect=" SELECT unidade_ens, nome_comp, setor, cgc, situacao,nucleo,municipio from VW_UNIDADE_ENSINO_SITUACAO "
        ...
        <tr>
            <td>
                <asp:Panel ID="pnGrid" runat="server" GroupingText="Lista de Candidatos" Visible="false">
                    <dxwgv:ASPxGridView ID="grdControle" runat="server" AutoGenerateColumns="False" EnableCallBacks="false"
                        ...
                        <Columns>
                            <dxwgv:GridViewCommandColumn VisibleIndex="0" ButtonType="Image" Width="0px" ShowInCustomizationForm="true">
                                ...
                                <CustomButtons>
                                    <dxwgv:GridViewCommandColumnCustomButton Text="Retornar" ID="btnConfirmar" Visibility="AllDataRows">
                                        <Image Url="../Images/ico_voltar.png" Height="16px" AlternateText="Retornar"></Image>
                            ...
                            <dxwgv:GridViewDataColumn Caption="Motivo Retorno*" FieldName="MOTIVORETORNOID" Name="MOTIVORETORNOID"
                                UnboundType="String" visibleIndex="14" Width="120px">
                                <DataItemTemplate>
                                    <asp:HiddenField runat="server" ID="hfMotivo" Value='<%# Bind("MOTIVORETORNOID") %>' />
                                    <asp:DropDownList ID="ddlMotivo" runat="server" DataSourceID="odsMotivoRetorno"
                                        DataTextField="DESCRICAO" DataValueField="MOTIVORETORNOID" Width="200px">
                                    </asp:DropDownList>
                                </DataItemTemplate>
                    ...
                    <asp:ObjectDataSource ID="odsMotivoRetorno" runat="server" SelectMethod="ListaAtivoPor"
                        TypeName="Techne.Lyceum.RN.Matriculas.MotivoRetorno"></asp:ObjectDataSource>
                </asp:Panel>
            </td>
        </tr>
    </table>
    <br />
    <asp:ObjectDataSource ID="odsControle" TypeName="Techne.Lyceum.Net.Matricula.RetornoNaoConfirmado"
